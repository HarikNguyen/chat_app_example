# Generated by Django 4.0.6 on 2022-08-08 01:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role_name', models.CharField(max_length=150, unique=True, verbose_name='role name')),
            ...
            managers=[
                ('roles', django.contrib.auth.models.GroupManager()),
            ],
        ),
        migrations.CreateModel(
            name='Employee',
            ...
            managers=[
                ('managers', accounts.managers.EmployeeManager()),
            ],
        ),
    ]
